...
<head>
    ...
    <title>Registro Persona - SoloSuper!</title>
</head>
...
<body style="background-color: #dddd;">
    ...
    <div class="w-100 h-100 d-flex justify-content-center align-content-center align-items-center">
        <form action="./registroPBcknd.php" method="POST" class="p-4 border rounded col-lg-4" style="background-color:white;">
            <h1 class="mb-3 w-100 text-center">Registro Persona</h1>

            <div class="input-group mb-3">
                <span class="input-group-text span">Nombre</span>
    ...
    <a href="./registroEVista.php" class="fixed-bottom">¿Necesitas una cuenta de Empresa?</a>
