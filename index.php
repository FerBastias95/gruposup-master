        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex">
                        <button class="btn btn-outline-dark" type="submit">
                            <a href="../gruposup-master/Registros/registroPVista.php" class="bi bi-door-open-fill">Registro Personas</a>
                            <span class="badge bg-dark text-white ms-1 rounded-pill"></span>
                        </button>       
                        <button class="btn btn-outline-dark" type="submit">
                            <a href="../gruposup-master/Registros/registroEVista.php" class="bi bi-door-open-fill">Registro Empresas</a>
                            <span class="badge bg-dark text-white ms-1 rounded-pill"></span>
                        </button>               
                    </form>
                </div>
            ...
            <div class="parent-container d-flex">
                ...
                <div class="container px-4 px-lg-4 mt-4">
                    <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                        ...
                        <div class="col mb-5">
                            <div class="card h-100" data-href="product.php?img=<?php echo $record['link_Img']; ?>&precio=<?php echo $record['precioProd']; ?>&id=<?php echo $record['idProd']; ?>&ids=<?php echo $record['idSuper']; ?>&nombre=<?php echo $record['nombreProd']; ?>&cat=<?php echo $record['catProd']; ?>">
